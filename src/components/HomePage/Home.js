          ...
          >
            <div className="flex lg:min-w-0 lg:flex-1" aria-label="Global">
              <a href="#" className="-m-1.5 p-1.5 text-xl font-bold">
                ...
                Hoila ☺️ <span className=" text-indigo-600">!!!</span>
              </a>
              {/* <>{location.state.message}</>
              <>{location.state.data.map(number => <>{number}</>)}</> */}
            </div>
            ...
            <div
              className="hidden lg:flex lg:min-w-0 lg:flex-1 lg:justify-end cursor-pointer"
            ...
            >
              ...
              <div className="mt-6 flow-root">
                <div className="-my-6 divide-y divide-gray-500/10">
                  ...
                  <div className="py-6" onClick={() => naviagte("/auth/login")}>
